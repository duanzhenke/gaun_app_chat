...
import com.guan.utils.SnowFlake;
 ...
 */
@Service
public class GuanChatServiceImpl extends ServiceImpl<GuanChatMapper, GuanChat> implements
    IGuanChatService {
...
/*        guanChat.setPassWord(passwordEncoder
    ...
    if (guanChat.getUserName() == null) {
      guanChat.setUserName("app" + id);
    }
